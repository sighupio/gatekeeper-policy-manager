# Gatekeeper Policy Manager release v2.1.0

Welcome to the release of Gatekeeper Policy Manager `v2.1.0`, maintained with ❤️ by the team [SIGHUP by ReeVo](https://sighup.io/).
